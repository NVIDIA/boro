...
#[derive(RustEmbed)]
#[folder = "resources/prompts/kernel.local/"]
...
const SUBSYSTEM_MAP: &[(&str, &str)] = &[
    ...
    ("tools/", "build.md"),
    ("drivers/i2c/", "i2c.md"),
    ("include/linux/i2c.h", "i2c.md"),
    ("drivers/hid/", "hid.md"),
    ("include/linux/hid.h", "hid.md"),
